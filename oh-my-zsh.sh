...
# source "$ZSH/tools/check_for_upgrade.sh" # Commented out to speed up remote integrations
...
# zcompdump_revision="#omz revision: $(builtin cd -q "$ZSH"; git rev-parse HEAD 2>/dev/null)" # Commented out to speed up remote integrations
# zcompdump_fpath="#omz fpath: $fpath" # Commented out to speed up remote integrations
